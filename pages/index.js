  ...
  return (
    <Layout title="Pokedex">
      ...
      <div className="flex flex-col items-center">
        <div className="inline-flex m-8 xs:mt-0">
          <button
            className="inline-flex items-center px-4 py-2 text-sm md:text-lg font-medium text-white bg-gray-800 rounded-l hover:bg-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          ...
          <button
            className="inline-flex items-center px-4 py-2 text-sm md:text-lg font-medium text-white bg-gray-800 border-0 border-l border-gray-600 rounded-r hover:bg-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
            onClick={handleNext}
          >
            Next
            <svg
